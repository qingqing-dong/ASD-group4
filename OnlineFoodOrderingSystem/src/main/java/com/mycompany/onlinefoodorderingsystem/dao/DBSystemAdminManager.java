...
//Find user by email and password in the database   
    public SystemAdmin findSystemAdmin(String email, String password) throws SQLException {
        ...
        String fetch = "SELECT * FROM OFOS.SYSTEM_ADMIN WHERE EMAIL='" + email + "' AND PASSWORD='" + password + "'";
...
//Add a user-data into the database   
    public void addSystemAdmin(String firstName, String lastName, String eMail, String password, String gender, String address, String phoneNumber, String startDate, String endDate, String position) throws SQLException {                   //code for add-operation       
        st.executeUpdate("INSERT INTO OFOS.SYSTEM_ADMIN (FIRSTNAME, LASTNAME, EMAIL, PASSWORD, GENDER, ADDRESS, PHONENUMBER, STARTDATE, ENDDATE, POSITION) " + "VALUES('" + firstName + "','" + lastName + "','" + eMail + "','" + password + "','" + gender + "','" + address + "','" + phoneNumber + "','" + startDate + "','" + endDate + "','" + position + "')");
    }
...
//update a user details in the database   
    public void updateSystemAdmin(String userID, String firstName, String lastName, String eMail, String password, String gender, String address,  String phoneNumber, String startDate, String endDate, String position) throws SQLException {
        ...
        st.executeUpdate("UPDATE OFOS.SYSTEM_ADMIN SET FIRSTNAME='" + firstName + "', LASTNAME='" + lastName + "',EMAIL='" + eMail + "',PASSWORD='" + password + "',GENDER='" + gender + "',ADDRESS='" + address + "', PHONENUMBER='" + phoneNumber + "',STARTDATE='" + startDate + "', ENDDATE='"+ endDate +
                "' WHERE USERID=" + userID + "");
    }
...
//delete a user from the database   
    public void deleteStaff(String userID) throws SQLException {
        ...
        st.executeUpdate("DELETE FROM OFOS.SYSTEM_ADMIN WHERE USERID=" + userID + "");
    }
    
    public ArrayList<SystemAdmin> fetchStaffs() throws SQLException {
        ResultSet rs = st.executeQuery("SELECT * FROM OFOS.SYSTEM_ADMIN");
    ...
    public boolean checkSystemAdmin(String userID) throws SQLException {
        ResultSet rs = st.executeQuery("SELECT * FROM OFOS.SYSTEM_ADMIN WHERE USERID=" + userID + "");
        if (rs.next()) {
            return true;
        }
        return false;
