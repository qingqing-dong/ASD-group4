...
<html>
    ...
    <body>
        ...
        <div class="login_form">
            <form action="Validator"action="Validator" method="post">
                ...
                <p><input type="checkbox"/> Remember me<a class="forgot_password" href="retrieve_password.jsp">Forgot your password?</a></p>
