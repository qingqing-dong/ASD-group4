    ...
    <body>
        ...
        %>
         ...
         <div class="register_form">
            ...
            <tr><td>Password</td><td><input type="password" name="password" value="<%=staff.getPassword() %>"required></td></tr>
            <tr><td><input class="button" type="submit" value="update"></td> <td><a type="cancel" href="StaffEditServlet?id=<%= staff.getId()%>">back</a></td></tr>
        </table>
            </form>
